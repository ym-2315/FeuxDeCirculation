...
HD_PWD='C:/Users/PC/Vivado/FeuxDeCirculation/FeuxDeCirculation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FeuTriColorSysteme.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FeuTriColorSysteme.tcl -notrace
